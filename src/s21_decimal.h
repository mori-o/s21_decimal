...
typedef enum s21_error_code {
  S21_OK = 0,
  S21_OVERFLOW = 1,   // or S21_OF = 1
  S21_UNDERFLOW = 2,  // or S21_UF = 2
  S21_DIV_BY_ZERO = 3
} s21_error_code;
...
int divide_by_10(s21_decimal *num);
int remove_trailing_zeros(s21_decimal *num);
// double decimal_to_double(s21_decimal decimal);
void multiply_by_ten(s21_decimal *dec);
void divide_by_ten(s21_decimal *dec, int *remainder);
...
void s21_sub_int256(s21_int256 value_1, s21_int256 value_2, s21_int256 *result);
int s21_mul_int256(s21_int256 value_1, s21_int256 value_2, s21_int256 *result);